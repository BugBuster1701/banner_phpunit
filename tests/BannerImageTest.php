...
class BannerImageTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertEquals('3.2.0', $this->object->getVersion());
    }
    ...
    public function providerbannerimage()
    {
        return array(
        		...
        		array( array('0'=>'192','1'=>'54','2'=>'2','3'=>'width="192" height="54"','bits'=>8,'channels'=>3,'mime'=>'image/jpeg')
        		          , 'system/modules/banner_phpunit/tests/images/bugbuster-phpunit.jpg' , 'banner_image' ),
        		//png
        		array( array('0'=>'192','1'=>'54','2'=>'3','3'=>'width="192" height="54"','bits'=>8,'mime'=>'image/png')
        		          , 'system/modules/banner_phpunit/tests/images/bugbuster-phpunit.png' , 'banner_image' ),
        		//gif
        		array( array('0'=>'192','1'=>'54','2'=>'1','3'=>'width="192" height="54"','bits'=>8,'channels'=>3,'mime'=>'image/gif')
        		          , 'system/modules/banner_phpunit/tests/images/bugbuster-phpunit.gif' , 'banner_image' ),
        		//false test
        		array(false, 'system/modules/banner_phpunit/tests/images/non_existent.jpg'     , 'banner_image' ),
        		...
        		array( array('0'=>'160','1'=>'40','2'=>'13','3'=>'width="160" height="40"','mime'=>'application/x-shockwave-flash')
        		        , 'system/modules/banner_phpunit/tests/flash/bugbuster-phpunit.swc.swf' , 'banner_image' ),
        		//flash swf
        		array( array('0'=>'234','1'=>'60','2'=>'4' ,'3'=>'width="234" height="60"','mime'=>'application/x-shockwave-flash')
        		        , 'system/modules/banner_phpunit/tests/flash/bugbuster-phpunit.swf.swf' , 'banner_image' )
        		);
    }
    
    /**
     * Test for getBannerImageSizeNew()
     *
     * @dataProvider providerbannerimagenew
     */
    public function testGetBannerImageSizeNew($result,$oldWidth,$oldHeight,$newWidth,$newHeight)
    {
    	//Result must be equal
    	$this->assertEquals($result,$this->object->getBannerImageSizeNew($oldWidth,$oldHeight,$newWidth,$newHeight));
    }
    public function providerbannerimagenew()
    {
        return array(
                ...
                //new width only
                array( array('100','150',false) ,'200','300',  '100',''),
                //new heigh only
